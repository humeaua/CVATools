...
# define LOG_MAX 30
    ...
    if ( !initialized || dim_num != dim_num_save )
    {
        ...
        {
            std::cout<< "  n";
            std::cout << "I4_SOBOL - Fatal error!  n";
            std::cout << "  The spatial dimension DIM_NUM should satisfy:  n";
            std::cout << "    1 <= DIM_NUM <= " << DIM_MAX2 << "  n";
            std::cout << "  But this input value is DIM_NUM = " << dim_num << "  n";
            exit ( 1 );
        }
    ...
    if ( maxcol < l )
    {
        std::cout << "  n";
        std::cout << "I4_SOBOL - Fatal error!  n";
        std::cout << "  The value of SEED seems to be too large!  n";
        std::cout << "  SEED =   " << *seed  << "  n";
        std::cout << "  MAXCOL = " << maxcol << "  n";
        std::cout << "  L =      " << l << "  n";
        exit ( 2 );
    }
    //
...
//
{
    ...
    {
        std::cerr << "  n";
        std::cerr << "I4_UNIFORM - Fatal error!  n";
        std::cerr << "  Input value of SEED = 0.  n";
        exit ( 1 );
    }
    ...
    *seed = 16807 * ( *seed - k * 127773 ) - k * 2836;
    ...
    //
    r = ( 1.0 - r ) * ( ( float ) ( std::min ( a, b ) ) - 0.5 )
    +         r   * ( ( float ) ( std::max ( a, b ) ) + 0.5 );
    //
    //  Use rounding to convert R to an integer between A and B.
    //
    value = r4_nint ( r );
    
    value = std::max ( value, std::min ( a, b ) );
    value = std::min ( value, std::max ( a, b ) );
...
# define LOG_MAX 62
    ...
    if ( !initialized || dim_num != dim_num_save )
    {
        ...
        { 
            std::cout << "  n"; 
            std::cout << "I8_SOBOL - Fatal error!  n"; 
            std::cout << "  The spatial dimension DIM_NUM should satisfy:  n"; 
            std::cout << "    1 <= DIM_NUM <= " << DIM_MAX2 << "  n"; 
            std::cout << "  But this input value is DIM_NUM = " << dim_num << "  n"; 
            exit ( 1 ); 
...
{ 
    ...
    { 
        std::cerr << "  n"; 
        std::cerr << "I8_UNIFORM - Fatal error!  n"; 
        std::cerr << "  Input value of SEED = 0.  n"; 
        exit ( 1 ); 
    } 
    ...
    *seed = static_cast<int>(16807 * ( *seed - k * 127773 ) - k * 2836); 
    ...
    //  Scale R to lie between A-0.5 and B+0.5. 
    // 
    r = ( 1.0 - r ) * ( ( double ) ( std::min ( a, b ) ) - 0.5 )
    +         r   * ( ( double ) ( std::max ( a, b ) ) + 0.5 );
    // 
    //  Use rounding to convert R to an integer between A and B. 
    // 
    value = r8_nint ( r ); 
...
{ 
    ...
    { 
        std::cerr << "  n"; 
        std::cerr << "R4_UNIFORM_01 - Fatal error!  n"; 
        std::cerr << "  Input value of SEED = 0.  n"; 
        exit ( 1 ); 
    } 
...
{ 
    ...
    { 
        std::cerr << "  n"; 
        std::cerr << "R8_UNIFORM_01 - Fatal error!  n"; 
        std::cerr << "  Input value of SEED = 0.  n"; 
        exit ( 1 ); 
    } 
...
{ 
    ...
    { 
        std::cerr << "  n"; 
        std::cerr << "R8MAT_WRITE - Fatal error!  n"; 
        std::cerr << "  Could not open the output file.  n"; 
        return; 
    } 
    // 
    //  Write the data. 
